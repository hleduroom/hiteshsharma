...
import { ShareButtonClient } from '@/components/share-button-client';
import { FormatSelectorClient } from '@/components/format-selector-client';
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          >
            ...
            <FormatSelectorClient book={book} />
            <ShareButtonClient title={book.title} id={book.id} />
          </motion.div>
        </motion.div>

...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      publisher: { "@id": "https://thehiteshsir.com/#person" },
    },
    {
      "@type": "Organization",
      name: "H.L.-Eduroom",
    ...
    <>
      ...
      <section className="w-full min-h-screen flex items-center justify-center relative overflow-hidden bg-background dark:bg-black transition-colors duration-500">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/70 dark:from-black/80 dark:via-black/50 dark:to-black/70" />
        </div>
              ...
              <motion.div className="space-y-8 text-center lg:text-left">
                ...
                <motion.div className="space-y-4" variants={itemVariants}>
                  <div className="space-y-3">
                    ...
                    <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight font-shooting-star dark:text-white/90">{userDetails.name}</h1>
                  </div>
                ...
                <motion.div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start" variants={itemVariants}>
                  ...
                  <Button variant="outline" size="lg" className="border-white/30 text-white hover:bg-white/10 px-6 py-5 text-sm font-medium rounded-full backdrop-blur-sm transition-all duration-300 font-shooting-star" asChild>
